...
<nav class="nav-pc">
    <a href="/"><button class="btn nav-link active">главная</button></a>
...
<div class="nav-mobile mobile" id="nav-mobile">
    <a href="/"><button class="btn nav-link-mobile">главная</button></a>
...
<div class="content">
    ...
    <table class="news">
        <tbody>
        <tr class="str">
            <td class="docs"><a href="assets/files/news/2023/vipiska_7_23.pdf" target="_blank" class="a-news"><img src="assets/img/files/pdf.png" alt="docs" class="docs"></a></td>
            <td><a href="assets/files/news/2023/vipiska_7_23.pdf" target="_blank" class="a-news"><p class="news"> Выписка из протокола заседания президиума ФТСЛО № 07/23 от 27.09.23 г. </p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="assets/files/competitions/2023/07.10.pdf" target="_blank" class="a-news"><img src="assets/img/files/pdf.png" alt="docs" class="docs"></a></td>
            <td><a href="assets/files/competitions/2023/07.10.pdf" target="_blank" class="a-news"><p class="news"> Программа Рейтинг-турнира ФТСЛО 07.10.2023 г. </p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="assets/files/documents/protocols/06-23.pdf" target="_blank" class="a-news"><img src="assets/img/files/pdf.png" alt="docs" class="docs"></a></td>
            <td><a href="assets/files/documents/protocols/06-23.pdf" target="_blank" class="a-news"><p class="news"> Выписка из протокола заседания президиума ФТСЛО № 06/23 от 08.06.23 г. </p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="assets/files/competitions/2023/17.06.pdf" target="_blank" class="a-news"><img src="assets/img/files/pdf.png" alt="docs" class="docs"></a></td>
            <td><a href="assets/files/competitions/2023/17.06.pdf" target="_blank" class="a-news"><p class="news"> Соревнования по массовому спорту в рамках комплексного мероприятия ФТСАРР "В ритмах лета" 17-18 июня 2023 г. </p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="assets/files/documents/protocols/05-23.pdf" target="_blank" class="a-news"><img src="assets/img/files/pdf.png" alt="docs" class="docs"></a></td>
            <td><a href="assets/files/documents/protocols/05-23.pdf" target="_blank" class="a-news"><p class="news"> Выписка из протокола заседания президиума ФТСЛО № 05/23 от 12.05.23 г. </p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="assets/files/documents/extracts/extract from 02.23.pdf" target="_blank" class="a-news"><img src="assets/img/files/pdf.png" alt="docs" class="docs"></a></td>
        ...
        <tr class="str">
            <td class="docs"><a href="assets/files/competitions/2023/12.03.pdf" target="_blank" class="a-news"><img src="assets/img/files/pdf.png" alt="docs" class="docs"></a></td>
            <td><a href="assets/files/competitions/2023/12.03.pdf" target="_blank" class="a-news"><p class="news"> Программа Рейтинг-турнира ФТСЛО  12.03.2023 г.</p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="https://drive.google.com/drive/folders/1ICSr537DDjsQ7NCS-F_BzIvWq54kYUsj?usp=share_link" target="_blank" class="a-news"><img src="assets/img/files/web.png" alt="docs" class="docs"></a></td>
            <td><a href="https://drive.google.com/drive/folders/1ICSr537DDjsQ7NCS-F_BzIvWq54kYUsj?usp=share_link" target="_blank" class="a-news"><p class="news"> Регламенты Чемпионатов и Первенств 2023 г. </p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="assets/files/competitions/2023/21.01.pdf" target="_blank" class="a-news"><img src="assets/img/files/pdf.png" alt="docs" class="docs"></a></td>
            <td><a href="assets/files/competitions/2023/21.01.pdf" target="_blank" class="a-news"><p class="news"> ВНИМАНИЕ! Измененная программа ЧиП ФТСЛО  21.01.2023 г.</p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="https://lkds.vftsarr.ru/storage/competition_regulation_files/24391/ilovepdf_merged_compressed.pdf" target="_blank" class="a-news"><img src="assets/img/files/web.png" alt="docs" class="docs"></a></td>
            <td><a href="https://lkds.vftsarr.ru/storage/competition_regulation_files/24391/ilovepdf_merged_compressed.pdf" target="_blank" class="a-news"><p class="news"> Регламент проведения Чемпионата СЗФО </p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="assets/files/competitions/2022/17.12.pdf" target="_blank" class="a-news"><img src="assets/img/files/pdf.png" alt="docs" class="docs"></a></td>
            <td><a href="assets/files/competitions/2022/17.12.pdf" target="_blank" class="a-news"><p class="news"> Программа Рейтинг-турнира ФТСЛО; Муниципальных соревнований Гатчинского МР  17.12.2022 г.</p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><img src="assets/img/files/no.png" alt="docs" class="docs"></td>
            <td><p class="news"> Уважаемые коллеги, 07.12.22 на внеочередной конференции могут присутствовать не только руководители, но и представители коллективов. Если вы не можете присутствовать сами, пожалуйста, найдите возможность прислать на конференцию представителя своего коллектива. </p></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="calendar.html" target="_blank" class="a-news"><img src="assets/img/files/web.png" alt="docs" class="docs"></a></td>
            <td><a href="calendar.html" target="_blank" class="a-news"><p class="news">Рейтинг-турнир ФТСЛО и Муниципальные соревнования Гатчинского МР перенесены с 25 декабря 2022 г. на 17 декабря 2022г.</p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="assets/files/news/2022/Warning.doc" target="_blank" class="a-news"><img src="assets/img/files/doc.png" alt="docs" class="docs"></a></td>
            <td><a href="assets/files/news/2022/Warning.doc" target="_blank" class="a-news"><p class="news"> <b>Внимание!</b>
                        <br>В среду 07.12.22 г. в 12:00 состоится общее собрание руководителей коллективов – членов ФТСЛО (внеочередная конференция). </p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
            <td class="docs"><a href="calendar.html" target="_blank" class="a-news"><img src="assets/img/files/doc.png" alt="docs" class="docs"></a></td>
            <td><a href="calendar.html" target="_blank" class="a-news"><p class="news"> План соревнований на 2023 г. </p></a></td>
        </tr>
        <tr class="str enter">
        </tr>
        <tr class="str">
