  ...
  <div class="content">
    <div class="title-content">ОНЛАЙН-РЕГИСТРАЦИЯ</div>
      <div style="display: flex; justify-content: space-around; align-items: center; width: 100%; flex-wrap: wrap;">
        <?php
          if ($data[0]["ID"] == "") {
            echo("<h2>Пользователь не найден!</h2><div style=\"width:100%; height: 10px;\"></div><a href=\"../../reg.html\"><button class=\"btn-reg\">Назад</button></a>");
          } else {
            ...
            <a href=\"continue.php\"><button class=\"btn-reg\">Продолжить регистрацию</button></a>");
